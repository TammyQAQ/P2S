...
def plot_block_time_distribution(data):
    ...
    stats_text = f'Block Time Statistics:\n'
    ...
    ax.set_xlabel('Total Block Time (seconds)', fontsize=13, fontweight='bold')
    ax.set_ylabel('Frequency', fontsize=13, fontweight='bold')
    ax.set_title('Block Time Distribution', fontsize=15, fontweight='bold', pad=15)
